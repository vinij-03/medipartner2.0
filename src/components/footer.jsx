...
function footer() {
  return (
    <div className=' h-20 bg-gradient-to-r from-slate-900 to-cyan-900  items-center'>
      <ul className="flex  justify-between   ">
        <li className='flex items-center  '>
          <img src="logo.svg" className='w-5 h-6 m-1' alt="logo" />
          <a className='text-xl ' href='#'>
            <span className='text-teal-50'>medi</span><span className='text-teal-400'>Partner</span></a>
        </li>
        <p className=" text-white-400 ">Copyright © All rights reserved.medipartner </p>
