...
function home() {
    ...
    React.useEffect(() => {
      fetch('http://localhost:5173/data.json').then(response => response.json())
        .then(json =>{
  ...
  return (
    <>
      <div className="top  bg-gradient-to-r h-screen from-slate-900 to-cyan-900">
        <Navbar />
        <div class="flex flex-col">
          <div className="flex flex-col justify-center mt-44 mb-18 ml-6 text-6xl text-white font-bold pb-24 ">
            Health Innovation<br></br>Technology
          </div>
          <div className="inline-flex justify-center">
            <button class="bg-transparent hover:bg-gray-400 text-white font-bold py-2 px-4 inline-flex items-center border border-white-500 m-6 rounded ">
      ...
      <div className="features flex justify-around m-10 ">
        {data.map((item, index) => {
          return (
            <Cards key={index} title={item.title} des={item.des} image={item.image} />
          )
        })}
      </div>
      <Footer/>
